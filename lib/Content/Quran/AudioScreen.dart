              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Total Ayat : ${widget.list![currentIndex].jumlahAyat}',
                      ...
                      children: [
                        ...
                        Visibility(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(widget.list![currentIndex+1].nama!,style: TextStyle(color: Colors.black,
                                  fontSize: 20),),
                            ],
                          ),
                        ),
                        ...
                        Visibility(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Icon(currentIndex>111 ? null :Icons.play_circle_fill,color: hexStringToColor('03045E'),),
                              Text(currentIndex>111 ? '' : widget.list![currentIndex+2].nama!,style: TextStyle(color: Colors.black,
                                  fontSize: 20),),
                            ],
                          ),
                        ),
      ...
      children: [
        SliderTheme(
          data: SliderTheme.of(context).copyWith(
            activeTrackColor: hexStringToColor('03045E'),
            inactiveTrackColor: Colors.grey,
            trackHeight: 5.0,
            thumbColor: hexStringToColor('32AB58'),
